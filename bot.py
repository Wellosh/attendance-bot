...
def load():
    ...
    return {
        ...
        "students": {
            "ИС-21": ["Иванов Иван", "Петрова Мария", "Сидоров Алексей", "Козлова Анна", "Новиков Дмитрий"],
            "ИС-22": ["Морозов Кирилл", "Волкова Екатерина", "Лебедев Роман"],
            "ПО-21": ["Зайцева Ольга", "Соколов Максим", "Белов Артём"],
        },
        "subjects": ["Математика", "Программирование", "Базы данных", "Английский"],
        "records": [],
        "session": None,
